  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="Worker" component={WorkerPage} />
        <Stack.Screen name="AddClient" component={AddClientPage} />
        <Stack.Screen name="SearchClient" component={SearchClientPage} />
        <Stack.Screen name="Devices" component={DevicesPage} />
        <Stack.Screen name="EditClient" component={EditClientPage} />
        <Stack.Screen name="EditDevice" component={EditDevicePage} />
